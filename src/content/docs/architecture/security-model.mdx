...
description: "SCC security model: Docker isolation, trust boundaries, policy enforcement, and permission layers. How sandboxed Claude Code protects your system."
sidebar:
  order: 3
---
