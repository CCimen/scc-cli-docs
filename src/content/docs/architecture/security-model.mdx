...
|---------|----------------------|----------------------|
| Enforcement | Shell wrappers (defense-in-depth) | Agent-native hooks (Claude hooks, Codex rules) |
...
| Provider support | All providers (provider-neutral) | Claude Code (hooks), Codex (rules) |
