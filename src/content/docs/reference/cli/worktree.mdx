...
<Aside type="note">
  The worktrees directory is automatically created when you create your first worktree.
</Aside>
...
| `--start` / `--no-start` | Start an agent session after creating the worktree (default: `--start`) |
