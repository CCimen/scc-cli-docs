...
Personal profiles let you save and re-apply your own agent settings (plugins, MCP servers) per project. They're stored outside the repo and auto-applied on `scc start`.
...
- `settings` — Agent settings (plugins, etc.)
