...
<Aside type="note">
  Podman support is planned but not yet fully validated. If you're using Podman and encounter issues, consider switching to Docker Engine or OrbStack.
</Aside>
...
| **Sign-in needed** | Nothing present | Run `scc setup` |
