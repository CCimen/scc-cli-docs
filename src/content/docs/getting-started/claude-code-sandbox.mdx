...
<FAQSchema faqs={[
  { question: "Is SCC CLI a Claude Code CLI?", answer: "SCC CLI is a wrapper around the official Claude Code CLI. It runs Claude Code inside Docker and adds governance, isolation, and safety features." },
  { question: "Can I sandbox Claude Code without Docker?", answer: "SCC relies on Docker for isolation. If you need container-level sandboxing, Docker is the simplest and most widely supported option." },
  { question: "Is SCC an AI coding CLI?", answer: "Claude Code is the AI coding CLI. SCC manages and hardens how it runs." }
]} />
...
<CardGrid>
  <LinkCard
    ...
    description="Compare sandboxed and local execution"
  />
  <LinkCard
    title="Why Sandbox Claude Code"
    href="/use-cases/why-sandbox-claude-code/"
    description="Understand the risks sandboxing addresses"
  />
  <LinkCard
    title="AI Coding Guardrails"
    href="/use-cases/ai-coding-guardrails/"
    description="Implement safety rails for AI development"
  />
</CardGrid>
