...
description: "Why sandboxing AI coding agents matters: security risks, container isolation, and how SCC provides a governed runtime for Claude Code and Codex."
sidebar:
  order: 5
---
