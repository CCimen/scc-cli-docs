...
2. **Shows Quick Resume** if you have recent sessions for this workspace
3. **Prints brief context** (workspace root, entry directory, team) before launching
4. **Starts Docker container** with your team's configuration
