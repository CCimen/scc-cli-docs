...
A **team profile** defines the configuration for a group of users. An inline team profile can set:

| Setting | Description |
|---------|-------------|
| `additional_plugins` | Team-level plugin additions |
| `additional_mcp_servers` | Team-level MCP server additions |
