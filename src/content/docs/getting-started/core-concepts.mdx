...
# See current team's configuration
scc team info
```
...
SCC uses a three-layer configuration system:

```
┌──────────────────────────────────────┐
│         Organization Config          │  ← Security policies, blocked plugins
│         (org-config.json)            │    Set by: Org Admin
├──────────────────────────────────────┤
│           Team Profile               │  ← Team plugins, MCP servers
│      (inline or federated)           │    Set by: Team Lead
├──────────────────────────────────────┤
│         Project Config               │  ← Project-specific overrides
│           (.scc.yaml)                │    Set by: Developer
└──────────────────────────────────────┘
```

**Key rules:**
- Security blocks from org level cannot be overridden
- Teams can add plugins within allowed patterns
- Projects can extend but not remove team settings
