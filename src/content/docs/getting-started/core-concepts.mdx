...
Network policy is configured at the org or team level in the org config JSON. See [Security Model](/architecture/security-model/) for details on how topology enforcement works.
