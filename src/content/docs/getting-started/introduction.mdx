...
Your org config, team plugins, safety policies, and governance carry over regardless of which provider you use.
...
The optional **scc-safety-net** plugin provides additional coverage via agent-native hooks (Claude Code hooks, Codex rules).
