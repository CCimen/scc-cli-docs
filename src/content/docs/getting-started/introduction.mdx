---
title: What is SCC?
description: Introduction to SCC CLI - sandboxed coding CLI for running Claude Code in Docker containers
sidebar:
  order: 1
---
...
**SCC (Sandboxed Claude CLI)** is a sandboxed coding CLI that runs [Claude Code](https://docs.anthropic.com/en/docs/claude-code) (Anthropic's AI coding CLI) inside Docker containers with organization-managed team profiles and git worktree support.
...
Looking for a step-by-step guide? See [Sandbox Claude Code](/getting-started/claude-code-sandbox/) for a focused walkthrough.
...
- Security policies (network posture, base images)
