...
<FAQSchema faqs={[
  ...
  { question: "Can I sandbox AI coding agents without Docker?", answer: "SCC uses OCI containers for isolation through the Docker CLI. Validated v1 runtimes are Docker Engine, OrbStack, Colima, and Docker Desktop. Podman is not validated in v1." },
...
SCC uses OCI containers for isolation through the Docker CLI. Validated v1 runtimes are Docker Engine, OrbStack, Colima, and Docker Desktop. Podman is not validated in v1.
