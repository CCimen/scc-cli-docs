...
description: "Agent-native git protection hooks for Claude Code and Codex. Blocks push --force, reset --hard, branch -D, clean -fd. Complements SCC's built-in safety engine."
sidebar:
  order: 2
---
