---
title: Git Worktrees
description: "Git worktrees with SCC CLI: run multiple Claude Code sessions on parallel branches. Isolated AI development without branch conflicts or stashing."
sidebar:
  order: 4
---
...
<Aside type="caution">
  **Worktrees are created OUTSIDE your repository**, not inside it. This is a key design choice that keeps your main repository clean.
</Aside>

When you create a worktree, SCC places it in a sibling directory:

<DrawioDiagram src="/diagrams/worktree-structure2.svg" alt="Git Worktree Structure" />
