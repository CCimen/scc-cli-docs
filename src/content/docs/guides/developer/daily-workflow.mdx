...
| **Containers** | Running containers with action menus |
...
<Aside type="tip">
  Press `s` to access Settings & Maintenance for cache cleanup, session pruning, and config reset. See [Settings TUI](/guides/developer/settings-tui/) for details.
</Aside>
