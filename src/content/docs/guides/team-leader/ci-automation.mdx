...
```json
{
  ...
  "data": {
    "workspace_root": "/home/runner/project",
    "entry_dir": "/home/runner/project",
    "mount_root": "/home/runner/project",
    "container_workdir": "/home/runner/project",
    "team": "backend",
    "plugins": [
      { "name": "scc-safety-net@sandboxed-code-official", "source": "resolved" },
      { "name": "java-analyzer@internal", "source": "resolved" }
    ],
    "blocked_items": [],
    "network_policy": "web-egress-enforced",
    "ready_to_start": true,
    "resolution_reason": "Git repository detected at: /home/runner/project"
  }
}
```
...
```bash
# Validate team config file
scc team validate --file team-config.json

# Validate the resolved team (requires org config)
scc team validate ci
```
...
- Note: `web-egress-enforced` is topology-enforced for HTTP/HTTPS over IPv4 in v1. Raw TCP/UDP beyond HTTP(S) is not filtered. See the Security Model for details.
