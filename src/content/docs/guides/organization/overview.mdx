...
| `security.blocked_mcp_servers` | SCC-managed MCP server patterns nobody can use |
...
<Aside type="note">
  `blocked_mcp_servers` applies to MCP servers declared in org/team/project config. Plugin-bundled
  MCP servers are governed by plugin allow/block decisions.
</Aside>
...
<CardGrid>
  <Card title="Enterprise Pilot" icon="rocket">
    Plan a small governed rollout. [Pilot guide →](/guides/organization/enterprise-pilot/)
  </Card>
  ...
  <Card title="Enterprise Identity" icon="user">
    Review the planned SSO, SCIM, entitlement, and admin visibility model. [Roadmap →](/architecture/enterprise-identity/)
  </Card>
</CardGrid>
