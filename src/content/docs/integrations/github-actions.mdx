...
description: "Run SCC CLI in GitHub Actions to validate configuration, automate governed AI coding workflows, and launch sandboxed agent sessions in CI/CD."
---
...
<FAQSchema faqs={[
  ...
  { question: "Does SCC require Docker in GitHub Actions?", answer: "For validation (--dry-run), Docker is not required. For running actual sandboxed Claude Code or Codex sessions, you need a runner with Docker access (ubuntu-latest has Docker pre-installed)." }
]} />
