...
description: "Run SCC CLI in GitLab CI/CD to validate configuration, automate governed AI coding workflows, and launch sandboxed agent sessions in your pipelines."
---
