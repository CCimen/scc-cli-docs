...
This is a policy and explain contract only. The commands are not executed by SCC
yet, and the agent container still does not receive Docker socket access or
arbitrary project-network attachment.
