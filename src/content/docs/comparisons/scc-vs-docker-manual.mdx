...
description: "Compare SCC's automated container sandboxing to manually configuring Docker for AI coding agents. Setup complexity, maintenance, and feature differences explained."
---
...
## Example: Manual Docker Setup (Claude Example)

Here's what a minimal manual setup might look like for one provider:
...
<Aside type="caution">
  Manual Docker setups require ongoing maintenance as your agent CLI, Docker runtime, and your team's needs evolve. SCC handles those moving parts for you.
</Aside>
